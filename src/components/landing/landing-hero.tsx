...
const TABS: {
  ...
  },
  {
    ...
    subtitle: "Search homes ranked by proximity to churches across South Florida, with filters for distance and denomination.",
  ...
  },
  {
    ...
    subtitle: "Search homes ranked by proximity to mosques across South Florida, with smart distance filters.",
  ...
  },
  {
    ...
    subtitle: "Search homes ranked by proximity to Hindu and Buddhist temples across South Florida.",
